...
// The 'origin' property is used to specify which origins (domains) are allowed to access the resources on the server.
app.use(
	cors({
		origin: [
			'http://localhost:3000',
...
// testing
// app.get('/', (req, res) => {
// 	res.send('Hello, World!'); // You can modify this response as needed
// });
